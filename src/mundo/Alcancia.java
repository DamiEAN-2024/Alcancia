...
public class Alcancia {
    ...
    public int obtenerDenominacionMasNumerosa() {
        // TODO: Completar
    	int mayor = numeroMonedas50;
        int denominacion = 50;
        
        if (numeroMonedas100 > mayor) {
            mayor = numeroMonedas100;
            denominacion = 100;
        }
        if (numeroMonedas200 > mayor) {
            mayor = numeroMonedas200;
            denominacion = 200;
        }
        if (numeroMonedas500 > mayor) {
            mayor = numeroMonedas500;
            denominacion = 500;
        }
        if (numeroMonedas1000 > mayor) {
            mayor = numeroMonedas1000;
            denominacion = 1000;
        }
